...
//            ResultSet rs=st.executeQuery("Select*from donor1 where city like'%"+location+"%'or address like'%"+location"%'");
            ResultSet rs = st.executeQuery("SELECT * FROM adddonor WHERE city LIKE '%"+Location + "%' OR hospitaladdress LIKE '%" + Location + "%'");
